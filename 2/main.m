...
for i = 1:13
  ...
  plot(X, M(750:end, 2))
     ...
     ylabel("Absorbancja");
     set (gca (), "xdir", "reverse", "xtick", 700:100:4000)
...
plot(X, Y)
     ...
     set (gca (), "xdir", "reverse", "ytick", 0:0.025:0.2, "xtick", 700:100:4000)
     set(gcf, 'PaperSize', [23.2 8.2], 'PaperPosition', [0 0 23.2 8.2])
print ("Plots/Final1.pdf")
close()
plot(X, Y2)
     grid minor on
     axis("tight", "tic");
